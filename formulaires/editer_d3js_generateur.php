...
/**
 * Chargement du formulaire de configuration des d3js_generateur
 *
 * @return array
...
function formulaires_editer_d3js_generateur_charger_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	...
	if($d3js_generateur && $id_document) {
		foreach ($d3js_generateur as $cle => $valeur) {
...
/**
 * Vérifications du formulaire de configuration des d3js_generateur
 *
 * @return array
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_1_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_2_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_3_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_4_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_5_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_6_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_7_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_verifier_8_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
...
/**
 * Traitement du formulaire de configuration des d3js_generateur
 *
 * @return array
 *     Retours du traitement
**/
function formulaires_editer_d3js_generateur_traiter_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	...
	if($id_d3js_generateur)
		sql_updateq('spip_d3js_generateur', $set, 'id_d3js_generateur=' . intval($id_d3js_generateur));
	else
		$id_d3js_generateur = sql_insertq('spip_d3js_generateur', $set);

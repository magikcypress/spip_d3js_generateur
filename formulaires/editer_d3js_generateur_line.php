 ...
 * @author     cyp
 * @licence    GNU/GPL
 * @package    SPIP\forumlaire\d3js_generateur
 */

/**
 * Gestion du formulaire de d3js_generateur des sites 
 *
...
/**
 * Chargement du formulaire de configuration des d3js_generateur_line
 *
 * @return array
 *     Environnement du formulaire
**/
function formulaires_editer_d3js_generateur_line_charger_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){

	$valeurs = array();
	$d3js_generateur = sql_allfetsel('*', 'spip_d3js_generateur', 'id_d3js_generateur=' . intval($id_d3js_generateur));
	$id_document = sql_getfetsel('id_document', 'spip_documents_liens', 'id_objet=' . intval($id_d3js_generateur), '', 'id_document DESC', '1');

	if($d3js_generateur && $id_document) {
		foreach ($d3js_generateur as $valeur) {
...
/**
 * Vérifications du formulaire de configuration des d3js_generateur_line
 *
 * @return array
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_2_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_3_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_4_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_5_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	...
	if(_request('_etape') == 5) {
		...
		if($id_document) {
			...
			if(!isset($erreurs['form_donnees'])) {
				$tmp_dir = sous_repertoire(_DIR_TMP, 'd3js_generateur');
				if($tmp_dir) {
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_6_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_line_verifier_7_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
...
/**
 * Traitement du formulaire de configuration des d3js_generateur_line
 *
 * @return array
 *     Retours du traitement
**/
function formulaires_editer_d3js_generateur_line_traiter_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){

	$set = array();
	$id_d3js_generateur = sql_getfetsel('id_d3js_generateur', 'spip_d3js_generateur', 'id_d3js_generateur=' . intval($id_d3js_generateur));

	$set['id_d3js_generateur'] = $id_d3js_generateur;
	...
	if($id_d3js_generateur) {
		...
		sql_insertq('spip_d3js_generateur', $set);
	}

	if($fichier = _request('fichier')) {
		$ajouter_documents = charger_fonction('ajouter_documents', 'action');
		$nouveaux_doc = $ajouter_documents($id_document,array(array('tmp_name'=> $fichier, 'name' => basename($fichier))),'d3js_generateur',$id_d3js_generateur,'document');
	}

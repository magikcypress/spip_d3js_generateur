...
/**
 * Chargement du formulaire de configuration des d3js_generateur_bar
 *
 * @return array
 *     Environnement du formulaire
**/
function formulaires_editer_d3js_generateur_bar_charger_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
...
/**
 * Vérifications du formulaire de configuration des d3js_generateur_bar
 *
 * @return array
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_2_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_3_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_4_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_5_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_6_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3js_generateur_bar_verifier_7_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
...
/**
 * Traitement du formulaire de configuration des d3js_generateur_bar
 *
 * @return array
 *     Retours du traitement
**/
function formulaires_editer_d3js_generateur_bar_traiter_dist($id_d3js_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
